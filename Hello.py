...
def clustering_and_classification(processed_data):
    from sklearn.cluster import KMeans
    ...
    if show_cluster_result:
        ...
        abstract = []
        cluster = []
        for i, doc in enumerate(processed_data):  # Menggunakan hasil akhir preprocessing
            abstract.append(doc)
        ...
        X_train, X_test, y_train, y_test = train_test_split(processed_data, df_cluster['Cluster'], test_size=0.2, random_state=42)
